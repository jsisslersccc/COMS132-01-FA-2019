...
public class Bartok : MonoBehaviour
{
	...
	public bool ValidPlay(CardBartok cb)
	{
        ...
        if (gameMode == GameMode.Mode.facesWild && cb.rank > 10) return (true);
        ...
        if (gameMode == GameMode.Mode.rankPlusMinus && (absdiff == 1 || absdiff == 12)) return (true);
    ...
    {
        GTGameOver.GetComponent<GUIText>().text = "Game Fail!";
	...
	{
		CURRENT_PLAYER = null;
        FindObjectOfType<BuildOrderSceneLoader>().LoadStartScene();
